...
namespace Transfinite
{
  ...
  ParameterizationBilinear::
  ParameterizationBilinear(Surface *surface) : Parameterization(surface)
  {
  }
  ...
  Point2D ParameterizationBilinear::
  mapToRibbon(Point2D const &uv) const
  {
